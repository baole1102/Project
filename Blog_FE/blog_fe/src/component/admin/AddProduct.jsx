...
import { addProductByAdmin } from '../../service/Admin';
                                ...
                                <div >
                                    <section className="home-section">
                                        <div className="container body_movie bg-white">
                                            <h1 style={{ paddingTop: "20px", display: 'flex', justifyContent: 'center' }}>Thêm mới Sản Phẩm</h1>
                                            <Formik initialValues={initialValue}
                                                ...
                                                onSubmit={(data) => {
                                                    ...
                                                    addProductByAdmin(data).then(res => {
                                                        console.log(res);
                                                        Swal.fire({
                                                            title: "Sản phẩm đã được lưu thành công!",
